(function ($) {
	...
	var FasheonApp = {
		...
		/* ---------------------------------------------
		 ...
		 --------------------------------------------- */
		initializ: function() {
			FasheonApp.header_overlay();
			FasheonApp.onePageMenu();
			FasheonApp.Fasheon_menu();
			FasheonApp.Fasheon_select();
			FasheonApp.allCarousel();
			FasheonApp.coming_soon_timer();
			FasheonApp.progress_var();
			FasheonApp.service_item_mobile();
			FasheonApp.widget_mobile();
			FasheonApp.datePicker();
			FasheonApp.ajax_chimp();
			FasheonApp.contact_form();
			FasheonApp.reservation_form();
			FasheonApp.scroll_top();
		}
	};
	/* ---------------------------------------------
	 ...
	 --------------------------------------------- */
	$(function() {
		FasheonApp.initializ();
	});

	$(window).on('load', function() {
		FasheonApp.hoverAnimation();
	});
})(jQuery);
